 ...
 *
 * **This file is the document; C9c is the sending.** Everything here drives
 * `buildOrderConfirmation` directly, so a subscriber that built the message and
 * dropped it would pass all of it. That is C9c's own assertion to make, and it
 * makes it by driving the subscriber with a fake container.
 */
