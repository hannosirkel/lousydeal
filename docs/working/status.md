...
| In flight | F2, the gift message's parcel. Branch `deal/ld11-f2-gift-parcel`, worktree `.worktrees/lousydeal/ld11-f2`. |
| Next action | Land F2. Order #1's three customer-facing defects are then closed; F4, F5 and F6 remain in part one. LD-07 remains deferred out of V1. |
| Blocked | Nothing. |
...
| **LD-11 — User experience** | **open, started.** Sixteen rows in three parts; F3 closed by #238, F1 by #239, F2 in flight. Not V1. [`ld-11-user-experience.md`](./ld-11-user-experience.md) |
