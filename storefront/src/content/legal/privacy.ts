  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "Google Analytics and Meta Pixel are optional measurement tools. They load only after you agree in the analytics choice below the footer, and receive only fixed funnel events: never a page address, query, title, certificate serial, form entry or other identifier. Refusing, or later stopping analytics from the same control, keeps them off. The one preference this site stores for that choice is lousydeal.analytics-consent.v1; it says only whether you agreed or refused.",
    ...
    },
    {
      ...
      body: [
        ...
        "Google Analytics and Meta Pixel receive the fixed funnel events described in §2 only after your opt-in. We use them to understand whether the shop's purchase path is usable, not to advertise to you. Their respective privacy notices govern their processing.",
