  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "When you use it we send you the receipt § 56⁴(4) requires, on a durable medium, at once — and the page also shows you the statement, the date and the time, so you have it even if the message goes astray. Keep whichever reaches you: § 56(2¹) dates your withdrawal from when you sent it, not from when we acted on it.",
    ...
    },
    {
      ...
      body: [
        ...
        "Where all three conditions in §3 are met, the law would leave nothing to return on a withdrawal from the certificate. But §4 says we will not refuse on that ground, and that promise is what governs: if you withdraw from a certificate, we refund you. The Terms of Service say the same in §6, and neither of us gets to read the two documents differently.",
